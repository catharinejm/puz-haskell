...
The clues are arranged numerically. When two clues have the same number, the Across clue comes
...
These solutions are given as an ascii string. For each rebus there is a number, a colon, a string
